...
test("should return ['success p2']", () => {
  ...
  return expect(resolver(promises)).resolves.toEqual([
    "success p2",
    "success p3",
  ]);
}, 6000);
...
test('should return ["success p5","success p6"]', () => {
  ...
  return expect(resolver([promise4, promise5, promise6])).resolves.toEqual([
    "success p5",
    "success p6",
  ]);
}, 6000);
...
test("should return []", () => {
  ...
  return expect(resolver([promise7, promise8, promise9])).resolves.toEqual([]);
}, 6000);
